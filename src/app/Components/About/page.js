...
const skills = [
  {
    ...
    description:
      "Creating responsive and modern user interfaces with React.js, focusing on performance and accessibility.",
    bgColor: "bg-white",
  ...
  },
  {
    ...
    description:
      "Integrating mockups and designs into HTML/CSS with a keen eye for detail and multi-browser compatibility.",
    bgColor: "bg-gray-800",
    textColor: "text-white",
  },
  {
    ...
    description:
      "Optimizing sites for fast loading speed and maximum performance by minimizing files and optimizing images.",
    bgColor: "bg-white",
    textColor: "text-gray-800",
  },
];
